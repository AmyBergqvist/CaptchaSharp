...
using CaptchaSharp.Services.CapMonsterCloud.Requests;
...
using CaptchaSharp.Services.CapMonsterCloud.Responses;
...
{
    /// <summary>The service provided by <c>https://capmonster.cloud/</c></summary>
    public class CapMonsterCloudService : CaptchaService
    {
        ...
        public CapMonsterCloudService(string apiKey, HttpClient httpClient = null)
        {
            ...
            this.httpClient.BaseAddress = new Uri("https://api.capmonster.cloud");
        }
